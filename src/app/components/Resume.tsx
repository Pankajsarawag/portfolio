import Diversity1Icon from '@mui/icons-material/Diversity1'; import SchoolIcon from '@mui/icons-material/School';
    ...
    return (
        <>
                ...
                <div className="Position-of-Responsibility">
                    ...
                    <div className="Por-2">
                        <h1>Public Relation and Publicity Head, Aayaam, NIT trichy </h1>
