            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
                ...
                <Accordion style={{ background: "rgba(26,26,26)", color: "white", borderRadius: "20px" }} expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                    ...
                    <AccordionDetails style={{ background: "rgba(20, 20, 20)", color: "white", borderRadius: " 0px 0px 20px 20px", fontSize: "1rem" }}>
                        ...
                        Developed an online exam platform utilizing TypeScript, Material-UI, Flask, Node.js, MongoDB, Redis,LaTeX, and OCR. This platform facilitates test creation, OCR text extraction, and secure response storage, providing a seamless testing experience for users.
                        </Typography>
                        <Typography textAlign={{ xs: "start", sm: "justify", md: "justify" }} >
                        The backend, built with Node.js and Flask,supports exam management, analytics, and real-time performance monitoring. The frontend, designed with Material-UI, ensures an intuitive and user-friendly interface, enhancing the overall user experience.
                        </Typography>
                    </AccordionDetails>
                </Accordion>
                ...
                >
                    <a style={{ display: 'flex', justifyContent: "center", alignItems: "center" }} href="https://github.com/Pankajsarawag/cbt"><LinkIcon style={{ color: "20a4b6", fontSize: "2rem", marginRight: "1rem" }} /><u>Code Link</u></a>
                </Box>
                ...
                <video width="100%" height="auto" controls style={{ marginBottom: "-0.5rem" }}>
                    <source src="./CBT_demo video.mp4" type="video/mp4" />
                </video>
            </div>
        </>
    );
